                            ...
                            {step === 1 ? (
                                ...
                                >
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <button className="group w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-lg bg-white hover:bg-white/95 transition-all text-[#1f1f1f] font-medium shadow-sm hover:shadow disabled:opacity-50 relative overflow-hidden">
                                        ...
                                        <button className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-lg bg-[#1f1f1f] hover:bg-[#2a2a2a] border border-white/10 hover:border-white/20 transition-all text-white font-medium">

                ...
                <div className="flex-1 flex items-center justify-center px-6 py-12">
                    ...
                    >
                        ...
                        <div className="space-y-3 mb-6">
                            {/* Premium 0G-Branded Google Sign-In */}
                            <button
                                onClick={triggerGoogleLogin}
                                disabled={googleLoading || !googleConfigured}
                                className="group w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-lg bg-white hover:bg-white/95 transition-all text-[#1f1f1f] font-medium shadow-sm hover:shadow disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden"
                            >
                                ...
                                <span className="relative z-10">
                                    {googleLoading ? 'Connecting to 0G...' : 'Continue with Google'}
                                </span>
                            </button>

                            {/* Premium 0G-Branded Apple Sign-In */}
                            <button
                                onClick={triggerAppleLogin}
                                disabled={!appleConfigured}
                                className="group w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-lg bg-[#1f1f1f] hover:bg-[#2a2a2a] border border-white/10 hover:border-white/20 transition-all text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                            >

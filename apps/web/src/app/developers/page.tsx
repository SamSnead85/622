    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="fixed inset-0 pointer-events-none">
                ...
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-[#00D4FF]/[0.03] blur-[120px] rounded-full" />
            </div>
                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-5 py-3 rounded-t-xl text-sm font-medium transition-all border-b-2 ${
                                    activeTab === tab.id
                                        ? 'bg-white/[0.05] text-white border-[#00D4FF]'
                ...
                <AnimatePresence mode="wait">
                    ...
                    {activeTab === 'overview' && (
                        <motion.div key="overview" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-8">
                            {/* Hero */}
                            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#00D4FF]/10 via-[#8B5CF6]/5 to-transparent p-8 md:p-12">
                                <div className="max-w-xl">
                                    ...
                                    <div className="flex gap-3">
                                        <button
                                            ...
                                            className="px-6 py-3 bg-[#00D4FF] text-black font-semibold rounded-xl hover:opacity-90 transition-opacity text-sm"
                                        >
                                ...
                                <div className="absolute -right-12 -bottom-12 w-64 h-64 bg-[#00D4FF]/10 rounded-full blur-3xl" />
                            </div>
                            ...
                            <div className="grid md:grid-cols-3 gap-4">
                                {[
                                    {
                                        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#00D4FF" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>,
                                        title: 'OAuth 2.0',
                                        desc: 'Secure authentication with granular permission scopes. Users authorize exactly what your app can access.',
                                    },
                                    {
                                        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#8B5CF6" strokeWidth="2"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>,
                                        title: 'RESTful API',
                        ...
                        <motion.div key="apps" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-6">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="px-5 py-2.5 bg-[#00D4FF] text-black font-semibold rounded-xl hover:opacity-90 transition-opacity text-sm flex items-center gap-2"
                                >
                                    ...
                                    >
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="bg-black/40 border border-white/10 rounded-lg px-4 py-2.5 font-mono text-sm mt-1 break-all text-[#00D4FF]">{createdCreds.apiKey}</div>
                                            </div>
                                        </div>
                                    ...
                                    >
                                        ...
                                        <div className="grid md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="text" value={newApp.name} onChange={(e) => setNewApp({ ...newApp, name: e.target.value })} placeholder="My Integration" className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm placeholder:text-white/20 focus:outline-none focus:border-[#00D4FF]/50" />
                                            </div>
                                            <div>
                                                <label className="block text-xs text-white/40 mb-1.5">Website URL</label>
                                                <input type="url" value={newApp.websiteUrl} onChange={(e) => setNewApp({ ...newApp, websiteUrl: e.target.value })} placeholder="https://yourapp.com" className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm placeholder:text-white/20 focus:outline-none focus:border-[#00D4FF]/50" />
                                            </div>
                                        </div>
                                        <div>
                                            <label className="block text-xs text-white/40 mb-1.5">Description</label>
                                            <textarea value={newApp.description} onChange={(e) => setNewApp({ ...newApp, description: e.target.value })} placeholder="What does your app do?" rows={2} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm placeholder:text-white/20 focus:outline-none focus:border-[#00D4FF]/50 resize-none" />
                                        </div>
                                        <div>
                                            <label className="block text-xs text-white/40 mb-1.5">OAuth Callback URL</label>
                                            <input type="url" value={newApp.callbackUrl} onChange={(e) => setNewApp({ ...newApp, callbackUrl: e.target.value })} placeholder="https://yourapp.com/callback" className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm placeholder:text-white/20 focus:outline-none focus:border-[#00D4FF]/50" />
                                        </div>
                                        <div>
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={`px-3 py-1.5 rounded-lg text-xs font-mono transition-all ${
                                                                selected ? 'bg-[#00D4FF]/20 text-[#00D4FF] border border-[#00D4FF]/30' : 'bg-white/5 text-white/40 border border-white/10'
                                                            }`}
                                                        >
                                                            {scope}
                                                        </button>
                                        ...
                                        <div className="flex justify-end gap-3 pt-2">
                                            ...
                                            <button onClick={createApp} disabled={!newApp.name.trim()} className="px-6 py-2.5 bg-[#00D4FF] text-black font-semibold rounded-xl text-sm disabled:opacity-30 hover:opacity-90 transition-opacity">
                                                Create Application
                                            </button>
                                        </div>
                                    </motion.div>
                                        ...
                                        <div key={app.id} className="bg-white/[0.02] border border-white/5 rounded-2xl p-6 hover:border-white/10 transition-colors">
                                            ...
                                            <div className="grid sm:grid-cols-4 gap-4 mb-4">
                                                <div className="bg-black/20 rounded-xl p-3">
                                                    ...
                                                    <div className="font-mono text-xs text-[#00D4FF] truncate">{app.clientId}</div>
                                                </div>
                                                <div className="bg-black/20 rounded-xl p-3">
                        ...
                        <motion.div key="docs" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-8">
                            ...
                            <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-6">
                                <h3 className="font-semibold mb-3 flex items-center gap-2">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#00D4FF" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                                    Authentication
                                </h3>
                                <p className="text-sm text-white/50 mb-4">Two authentication methods are supported:</p>
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="bg-black/30 rounded-xl p-4">
                                        <h4 className="text-sm font-semibold text-[#00D4FF] mb-2">API Key</h4>
...
{`X-Api-Key: 0g_your_api_key`}
                                    ...
                                    <div className="bg-black/30 rounded-xl p-4">
                                        <h4 className="text-sm font-semibold text-[#8B5CF6] mb-2">OAuth 2.0 Bearer Token</h4>
                            ...
                            <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-6">
                                ...
                                <div className="grid md:grid-cols-3 gap-4">
                                    {[
                                        ...
                                        { tier: 'Pro', limit: '1,000 req/min', color: 'text-[#00D4FF]' },
                                        { tier: 'Enterprise', limit: '10,000 req/min', color: 'text-[#8B5CF6]' },
                                    ].map(t => (
                                ...
                                <div className="p-5 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-2.5 font-mono text-sm text-[#00D4FF] placeholder:text-white/15 focus:outline-none focus:border-[#00D4FF]/50"
                                        />
                                    </div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="px-6 py-2.5 bg-[#00D4FF] text-black font-bold rounded-lg text-sm hover:opacity-90 transition-opacity disabled:opacity-50 font-mono"
                                        >
                                            {consoleLoading ? '...' : 'Send'}
                                        </button>
                                    </div>

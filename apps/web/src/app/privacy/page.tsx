            ...
            <main className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
                ...
                <div className="prose prose-invert prose-sm max-w-none space-y-8">
                    ...
                    <section>
                        ...
                        <p className="text-white/60 leading-relaxed">For privacy inquiries, please contact us through the Platform or visit our <Link href="/about" className="text-[#7C8FFF]/70 hover:text-[#7C8FFF] underline underline-offset-2">About page</Link>.</p>
                    </section>
                </div>
            </main>
        </div>

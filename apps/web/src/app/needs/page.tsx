...
const TYPE_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
    ANNOUNCEMENT: { label: 'Announcement', color: '#7C8FFF', bg: 'rgba(0,212,255,0.08)' },
    NEED: { label: 'Community Need', color: '#F472B6', bg: 'rgba(244,114,182,0.08)' },
    EVENT: { label: 'Event', color: '#99AAFF', bg: 'rgba(167,139,250,0.08)' },
        ...
        <div className="min-h-screen bg-[#0A0A0C] text-white">
            ...
            <div className="relative overflow-hidden border-b border-white/[0.04]">
                <div className="absolute inset-0">
                    <div className="absolute top-0 left-1/3 w-96 h-64 rounded-full blur-[120px] opacity-5 bg-[#7C8FFF]" />
                    <div className="absolute bottom-0 right-1/3 w-64 h-48 rounded-full blur-[100px] opacity-5 bg-[#6070EE]" />
                </div>
            ...
            <main className="max-w-5xl mx-auto px-4 py-6 sm:py-8">
                {loading ? (
                    ...
                    <div className="text-center py-16">
                        ...
                        <Link href="/signup" className="inline-block mt-4 px-5 py-2 rounded-xl bg-[#7C8FFF]/10 text-[#7C8FFF] text-xs font-medium hover:bg-[#7C8FFF]/15 transition-colors">
                            Get Started Free
                        </Link>
                    </div>
                ) : (
                                    ...
                                    <div className="p-5">
                                        ...
                                        {post.externalLink && isExpanded && (
                                            <a
                                                ...
                                                className="inline-flex items-center gap-1.5 mt-3 px-3 py-1.5 rounded-lg bg-[#7C8FFF]/10 text-[#7C8FFF] text-[10px] font-medium hover:bg-[#7C8FFF]/15 transition-colors"
                                            >
            ...
            <div className="border-t border-white/[0.04]">
                <div className="max-w-5xl mx-auto px-4 py-12 text-center">
                    ...
                    <div className="flex gap-3 justify-center">
                        <Link
                            href="/signup"
                            className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#7C8FFF] to-[#7C8FFF]/80 text-sm font-medium text-white hover:opacity-90 transition-opacity"
                        >
                            Get Started Free
                        </Link>
                        <Link

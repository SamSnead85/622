...
function Toggle({ enabled, onChange }: { enabled: boolean; onChange: () => void }) {
    return (
        <button
            onClick={onChange}
            className={`relative w-12 h-6 rounded-full transition-colors ${enabled ? 'bg-gradient-to-r from-[#7C8FFF] to-[#6070EE]' : 'bg-white/20'}`}
        >
            <motion.div
                    ...
                    {success ? (
                        ...
                        <>
                            ...
                            <button
                                ...
                                className="w-full py-3 rounded-xl bg-gradient-to-r from-[#7C8FFF] to-[#6070EE] text-white font-semibold hover:opacity-90 transition-opacity disabled:opacity-50"
                            >
                ...
                <div className="max-w-2xl mx-auto px-4 lg:px-6 py-6">
                                ...
                                {section.title === 'Notifications' && (
                                    <div className="px-4 py-3 border-t border-white/10">
                                        <button
                                            ...
                                            className="text-sm text-[#7C8FFF] hover:text-[#7C8FFF]/80 transition-colors font-medium"
                                        >
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#7C8FFF] to-[#6070EE] text-white font-semibold hover:opacity-90 transition-opacity flex items-center justify-center gap-3 shadow-lg"
                        >
                            <ZapIcon size={20} />

...
// Clean, modern icons for institutional-grade design
...
// Utility to apply size
const getSize = (size?: number) => size || 24;
...
// Vote / Ballot Icon
export function VoteIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}
...
// Tent / Camp Icon
export function TentIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}
...
// Newspaper Icon
export function NewspaperIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}
...
export function MedicalIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}
...
// Graduation Cap Icon
export function GraduationIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}
...
// Camera Icon
export function CameraIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}
...
export function PartyIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}
...
export function AttachIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}
...
// Smile / Emoji Icon
export function SmileIcon({ className = '', size }: IconProps) {
    const s = getSize(size);
    return (
        <svg
            width={s}

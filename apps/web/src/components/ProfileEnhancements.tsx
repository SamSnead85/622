...
export const PROFILE_THEMES: ProfileTheme[] = [
    { id: 'default', name: 'Default', accentColor: '#00D4FF', backgroundColor: '#0A0A0F', textColor: '#FFFFFF' },
...
export const VERIFICATION_BADGES: Record<VerificationType, VerificationBadge> = {
    verified: { type: 'verified', label: 'Verified', icon: '✓', color: '#00D4FF', description: 'This account has been verified' },

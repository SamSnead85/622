            ...
            <main className="pt-32 pb-24 px-6 max-w-3xl mx-auto">
                        ...
                        <div className="space-y-2.5">
                            {[
                                ...
                                <div key={i} className="flex items-start gap-3">
                                    <div className="w-5 h-5 rounded-full bg-[#7C8FFF]/10 border border-[#7C8FFF]/20 flex items-center justify-center shrink-0 mt-0.5">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#7C8FFF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="space-y-10">
                    ...
                    <section>
                        ...
                        <p className="text-white/55 leading-relaxed">
                            Read our full <Link href="/privacy" className="text-[#7C8FFF]/70 hover:text-[#7C8FFF] underline underline-offset-2 transition-colors">Privacy Policy</Link> for 
                    ...
                    <section>
                        ...
                        <p className="text-white/55 leading-relaxed">
                            ...
                            <Link href="/about" className="text-[#7C8FFF]/70 hover:text-[#7C8FFF] underline underline-offset-2 transition-colors">About page</Link>.

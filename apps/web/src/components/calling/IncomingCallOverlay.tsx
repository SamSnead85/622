                ...
                >
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            />
                            <motion.div
                                className="absolute inset-0 rounded-full bg-[#00D4FF]/10"
                                animate={{ scale: [1, 2, 1], opacity: [0.3, 0, 0.3] }}
                                transition={{ repeat: Infinity, duration: 2, delay: 0.5 }}
                            />
                            <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[#00D4FF] to-[#8B5CF6] flex items-center justify-center text-4xl font-bold relative z-10">
                                {callerAvatar ? (
                        ...
                        <div className="flex items-center gap-6 mt-4">
                            ...
                            {callType === 'video' && (
                                <button
                                    ...
                                    className="w-16 h-16 rounded-full bg-[#00D4FF] flex items-center justify-center hover:opacity-90 transition-opacity"

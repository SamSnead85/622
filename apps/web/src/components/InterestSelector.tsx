    ...
    return (
        <div className="min-h-screen bg-black text-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-30">
                <motion.div
                    className="absolute inset-0 bg-gradient-to-br from-[#00D4FF]/20 via-[#8B5CF6]/20 to-[#EC4899]/20"
                    animate={{
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 py-12">
                ...
                >
                    ...
                    >
                        <SparklesIcon size={32} className="text-[#00D4FF]" />
                    </motion.div>

                    <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-[#00D4FF] via-[#8B5CF6] to-[#EC4899] bg-clip-text text-transparent">
                        What interests you?
                    </h1>
                    ...
                    >
                        ...
                        {selected.size >= 3 && (
                            <motion.div
                                initial={{ scale: 0 }}
                                animate={{ scale: 1 }}
                                className="w-5 h-5 rounded-full bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] flex items-center justify-center"
                            >
                                <CheckIcon size={12} />
                            </motion.div>
                        )}
              ...
              ${selected.size >= 3
                                ? 'bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] hover:shadow-2xl cursor-pointer'
            ...
            `}
                    >
                        ...
                        {selected.size >= 3 && (
                            <motion.div
                                className="absolute inset-0 bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] opacity-0 hover:opacity-100 transition-opacity -z-10"
                                animate={{

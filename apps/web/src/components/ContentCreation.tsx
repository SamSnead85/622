    ...
    return (
        <div className="space-y-4 p-4 rounded-xl bg-white/5 border border-white/10">
                ...
                {options.map((option, index) => (
                    <div key={option.id} className="flex items-center gap-2">
                        ...
                        <input
                            ...
                            className="flex-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white placeholder:text-white/30 focus:outline-none focus:border-[#7C8FFF]/50"
                        />
                        {options.length > 2 && (
                            <button
            ...
            {options.length < 4 && (
                <button
                    onClick={addOption}
                    className="text-[#7C8FFF] text-sm hover:underline"
                >
                    + Add option
                </button>
            )}
            ...
            >
                ...
                <div className="p-4">
                    <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-white/40 focus:outline-none focus:border-[#7C8FFF]/50"
                        autoFocus
                    />
                </div>
                ...
                <div className="max-h-60 overflow-y-auto">
                    ...
                    {filteredLocations.map((location) => (
                        <button
                            ...
                            className={`w-full p-4 text-left hover:bg-white/5 flex items-start gap-3 ${selectedLocation?.id === location.id ? 'bg-[#7C8FFF]/10' : ''
                                }`}
                        >
                            <span className="text-lg">📍</span>
                            <div>

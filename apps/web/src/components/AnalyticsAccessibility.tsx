...
export function MiniChart({ data, height = 40, color = '#7C8FFF' }: MiniChartProps) {
...
export function SkipLink() {
    return (
        <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:rounded-lg focus:bg-[#7C8FFF] focus:text-white focus:font-semibold"
        >

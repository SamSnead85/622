...
export default function CommunityDetailPage() {
    ...
    if (error || !community) {
        return (
            <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4">
                ...
                <Link href="/communities" className="px-6 py-3 rounded-xl bg-[#7C8FFF] text-white font-semibold">
                    Back to Groups
                </Link>
            </div>
        );
    ...
    const brandColor = community.brandColor || '#7C8FFF';
        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="relative h-44 md:h-56">
                ...
                <div className="absolute top-4 right-4 z-10 flex gap-2">
                    ...
                    {isAdmin && (
                        <>
                            <Link href={`/communities/${communityId}/admin`} className="p-2.5 rounded-xl bg-[#7C8FFF]/20 backdrop-blur-sm text-[#7C8FFF] hover:bg-[#7C8FFF]/30 transition-colors" title="Admin Dashboard">
                    ...
                    <AnimatePresence mode="wait">
                            ...
                            <motion.div key="classroom" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-4">
                                <div className="bg-[#0A0A0F]/60 backdrop-blur rounded-2xl border border-white/10 p-8 text-center">
                                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-amber-500/10 flex items-center justify-center">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#7C8FFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                                    </div>
                        ...
                        {activeTab === 'calendar' && (
                            <motion.div key="calendar" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-4">
                                <div className="bg-[#0A0A0F]/60 backdrop-blur rounded-2xl border border-white/10 p-8 text-center">
                                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-amber-500/10 flex items-center justify-center">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#7C8FFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                                    </div>
                            ...
                            <motion.div key="chat" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                                <div className="bg-[#0A0A0F]/60 backdrop-blur rounded-2xl border border-white/10 overflow-hidden flex flex-col" style={{ height: 'calc(100vh - 400px)', minHeight: '400px' }}>
                                    ...
                                    <div className="flex-1 overflow-y-auto p-4 space-y-3">
                                        {chatLoading ? (
                                            <div className="flex justify-center py-4">
                                                <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#7C8FFF]" />
                                            </div>
                                                    ...
                                                    <div key={msg.id} className={`flex gap-2 ${isMe ? 'flex-row-reverse' : ''}`}>
                                                        ...
                                                        <div className={`max-w-[75%] ${isMe ? 'items-end' : 'items-start'}`}>
                                                            ...
                                                            <div className={`px-3.5 py-2 rounded-2xl text-sm ${
                                                                isMe
                                                                    ? 'bg-[#7C8FFF]/20 text-white rounded-br-md'
                                                        ...
                                                        return (
                                                            <button
                                                                ...
                                                                className={`w-full relative overflow-hidden rounded-xl border text-left transition-all ${
                                                                    isMyVote ? 'border-[#7C8FFF]/30' : 'border-white/10 hover:border-white/20'
                                                                }`}
                                                            >
                                                                {hasVoted && (

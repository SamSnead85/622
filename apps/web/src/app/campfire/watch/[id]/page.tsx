    ...
    return (
        ...
        >
            ...
            <div className="min-w-0">
                <span className="text-xs font-semibold text-[#00D4FF] mr-1.5">
                    {msg.user.displayName}
                    {msg.user.isVerified && <span className="ml-0.5 text-[#00D4FF]">✓</span>}
                </span>
        ...
        return (
            <div className="min-h-screen bg-[#050508] flex items-center justify-center text-white">
                <div className="text-center">
                    ...
                    <Link href="/campfire" className="text-[#00D4FF] hover:underline">Browse streams</Link>
                </div>
            </div>
        );
    }
                        ...
                        <div className="flex gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                                ...
                                <div className="flex items-center gap-2 text-sm text-white/50 mt-0.5">
                                    <Link href={`/profile/${stream.user.username}`} className="hover:text-[#00D4FF] transition-colors">
                ...
                <form onSubmit={handleSendMessage} className="p-3 border-t border-white/[0.06] flex-shrink-0 safe-area-pb">
                    <div className="flex gap-2">
                        <input
                            ...
                            disabled={!user}
                            maxLength={500}
                            className="flex-1 bg-white/[0.04] border border-white/[0.08] rounded-xl px-3 py-2.5 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#00D4FF]/40 focus:ring-1 focus:ring-[#00D4FF]/20 transition-all disabled:opacity-40"
                        />
                        <button
                            type="submit"

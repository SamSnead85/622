    ...
    return (
        <div className="min-h-screen bg-[#030305] text-white">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-[#6070EE]/[0.02] blur-[120px] rounded-full" />
            </div>
            ...
            <main className="relative z-10">
                ...
                <section className="pt-24 pb-20 md:pt-32 md:pb-28">
                    <div className="max-w-5xl mx-auto px-6">
                        <motion.div
                            ...
                            transition={{ duration: 0.8 }}
                        >
                            <p className="text-[#7C8FFF]/60 text-xs tracking-[0.4em] uppercase mb-6 font-light">About 0G</p>
                ...
                <AnimatedSection id="architecture" className="py-20 md:py-28 border-t border-white/5">
                    <div className="max-w-5xl mx-auto px-6">
                        <div className="mb-16">
                            <p className="text-[#7C8FFF]/60 text-xs tracking-[0.4em] uppercase mb-4 font-light">Architecture</p>
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                },
                                {
                                    ...
                                    color: 'text-[#7C8FFF] bg-[#7C8FFF]/10',
                                },
                                {
                            ...
                            {[
                                ...
                                <div key={item.num} className="grid md:grid-cols-12 gap-4 md:gap-8 py-8 md:py-10 border-b border-white/5">
                                    <div className="md:col-span-1">
                                        <span className="text-[#7C8FFF]/40 text-sm font-mono">{item.num}</span>
                                    </div>
                ...
                <AnimatedSection className="py-20 md:py-28 border-t border-white/5">
                    <div className="max-w-5xl mx-auto px-6 text-center">
                        <p className="text-[#6070EE]/60 text-xs tracking-[0.4em] uppercase mb-6 font-light">The Road Ahead</p>

                    ...
                    <div>
                                        ...
                                        {PRESET_BACKGROUNDS.filter(bg => bg.category === cat).map(bg => (
                                            <button
                                                ...
                                                className={`relative aspect-[3/1] rounded-lg overflow-hidden transition-all ${profile.coverUrl === bg.url
                                                    ? 'ring-2 ring-[#7C8FFF] ring-offset-1 ring-offset-[#0a0a0f]'
                                                    : 'hover:opacity-80'
                                                    }`}
                                                title={bg.label}
                                            >
                        ...
                        <div className="mt-3 p-3 rounded-xl bg-white/[0.02] border border-white/[0.04]">
                            <div className="flex items-center gap-2">
                                <div className="w-7 h-7 rounded-lg bg-[#7C8FFF]/10 flex items-center justify-center shrink-0">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#7C8FFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">

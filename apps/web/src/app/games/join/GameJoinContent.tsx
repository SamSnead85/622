...
// ============================================
// Game Join Content — Socket-based lobby for joining games
// ============================================
...
export default function GameJoinContent() {
        ...
        try {
            ...
            socket.on('connect', () => {
                socket.emit('game:join', { code, playerName: playerName.trim() }, (result: any) => {
                    ...
                    if (result?.success) {
                        setJoined(true);
                        setGameState(result.state || null);
                    } else {
            ...
            socket.on('game:error', (data: { message: string }) => setError(data.message));
        } catch (err) {
            setJoining(false);
    ...
    const gameTypeName = gameState?.type
        ? gameState.type.charAt(0).toUpperCase() + gameState.type.slice(1)
        : 'Game';
            ...
            <div className="w-full max-w-lg">
                ...
                <div className="bg-gray-900 rounded-2xl border border-gray-800 p-4 mb-6">
                    ...
                    <div className="space-y-2">
                        {gameState?.players.map((player) => (
                            ...
                            >
                                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center text-sm font-bold text-gray-900 shrink-0">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-gray-600 text-xs">
                        Privacy-first social platform with games, communities, and more
                    </p>
                </div>
            </div>
        </div>

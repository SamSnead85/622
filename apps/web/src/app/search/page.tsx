                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-10 py-3.5 text-white placeholder:text-white/30 focus:outline-none focus:border-[#7C8FFF]/50 transition-colors"
                                autoFocus
                                aria-label="Search"
                            />
                            {query && (
                            ...
                            {searchTabs.map((t) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl text-sm whitespace-nowrap transition-all ${
                                        type === t.id
                                            ? 'bg-[#7C8FFF]/15 text-[#7C8FFF] font-medium border border-[#7C8FFF]/20'
                ...
                <div className="max-w-3xl mx-auto px-4 lg:px-6 py-6">
                    ...
                    {isLoading && (
                        <div className="text-center py-12">
                            <div className="w-8 h-8 border-2 border-[#7C8FFF]/30 border-t-[#7C8FFF] rounded-full animate-spin mx-auto" />
                        </div>
                    )}
                                    ...
                                    <div className="space-y-2">
                                        {results.users.map((u: any) => (
                                            <Link key={u.id} href={`/profile/${u.username}`}
                                                ...
                                                <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] flex items-center justify-center text-sm font-bold flex-shrink-0 overflow-hidden">
                                                    {u.avatarUrl ? (
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-white font-medium text-sm truncate">
                                                        ...
                                                        {u.isVerified && <span className="text-[#7C8FFF] ml-1">✓</span>}
                                                    </p>
                                    ...
                                    <div className="space-y-2">
                                        {results.communities.map((community: any) => (
                                            <Link key={community.id} href={`/communities/${community.id}`}
                                                className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.06] hover:border-white/[0.1] transition-all">
                                                <div className="w-11 h-11 rounded-xl bg-[#6070EE]/20 flex items-center justify-center text-lg flex-shrink-0 overflow-hidden">
                                                    {community.iconUrl ? (
                                ...
                                <section>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {results.hashtags.map((tag: any) => (
                                            <span key={tag.id} className="px-3 py-1.5 rounded-xl bg-white/5 text-[#7C8FFF] text-sm border border-white/[0.06]">
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <Link href="/communities" className="p-4 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.06] hover:border-white/[0.1] transition-all group">
                                        <div className="w-10 h-10 rounded-xl bg-[#6070EE]/15 flex items-center justify-center mb-3">
                                            <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#6070EE" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <Link href="/messages" className="p-4 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.06] hover:border-white/[0.1] transition-all group">
                                        <div className="w-10 h-10 rounded-xl bg-[#7C8FFF]/15 flex items-center justify-center mb-3">
                                            <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#7C8FFF" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    {!communityOptIn ? (
                                        <button
                                            ...
                                            className="p-4 rounded-xl bg-gradient-to-br from-[#7C8FFF]/10 to-[#6070EE]/10 border border-[#7C8FFF]/20 hover:border-[#7C8FFF]/40 transition-all text-left"
                                        >
                                            <div className="w-10 h-10 rounded-xl bg-[#7C8FFF]/15 flex items-center justify-center mb-3">
                                                <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#7C8FFF" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
                                            ...
                                            <p className="text-[#7C8FFF] font-medium text-sm">Join Community</p>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white/40 text-xs mt-1 leading-relaxed">
                                                ...
                                                <button onClick={() => setShowJoinModal(true)} className="text-[#7C8FFF] hover:underline">

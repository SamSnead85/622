    ...
    if (!currentStory) {
        return (
            <div className="fixed inset-0 bg-black flex flex-col items-center justify-center text-white">
                ...
                <Link
                    href="/dashboard"
                    className="px-6 py-3 rounded-xl bg-[#7C8FFF] text-white font-semibold"
                >
                    Back to Feed
                </Link>
            </div>
                ...
                <div className="absolute top-8 left-4 right-4 z-40 flex items-center gap-3">
                    <Link href={`/profile/${currentStory.user.username}`}>
                        {currentStory.user.avatarUrl ? (
                            ...
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] flex items-center justify-center text-white font-bold border-2 border-white">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 z-40">
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                disabled={!reply.trim()}
                                className="p-3 rounded-full bg-[#7C8FFF] hover:opacity-90 transition-opacity disabled:opacity-40"
                            >

    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                ...
                <Link href="/search?tab=people" className="text-xs text-[#7C8FFF] hover:underline">
                    See All
                </Link>
            </div>
                ...
                {visibleSuggestions.slice(0, 5).map((user) => (
                    ...
                    >
                        <Link href={`/profile/${user.username}`} className="flex-shrink-0">
                            <div className="w-11 h-11 rounded-full overflow-hidden bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] p-[2px]">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1">
                                ...
                                {user.isVerified && <span className="text-[#7C8FFF]">✓</span>}
                            </div>
                        ...
                        <div className="flex items-center gap-2">
                            {followed.has(user.id) ? (
                                ...
                                <button
                                    ...
                                    className="px-4 py-1.5 rounded-full bg-[#7C8FFF] text-white text-xs font-semibold hover:opacity-90 transition-opacity"
                                >
                                    Follow
                                </button>
                            )}
        ...
        <div className="relative">
            ...
            >
                ...
                {onAddStory && (
                    ...
                    >
                        <div className="w-16 h-16 rounded-full border-2 border-dashed border-white/30 flex items-center justify-center hover:border-[#7C8FFF] transition-colors">
                ...
                {stories.map((story) => (
                    ...
                    >
                        <div className={`p-[3px] rounded-full ${story.hasUnseenStory
                            ? 'bg-gradient-to-br from-[#7C8FFF] via-[#6070EE] to-[#F43F5E]'
                            : 'bg-white/20'
                            }`}>
                            <div className="w-14 h-14 rounded-full overflow-hidden bg-[#1A1A1F] border-2 border-[#1A1A1F]">
                                {story.user.avatarUrl ? (
                                    ...
                                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] text-white font-bold text-lg">
            ...
            >
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-1">
                                    ...
                                    {parentComment.author.isVerified && <span className="text-[#7C8FFF]">✓</span>}
                                ...
                                <div className="flex items-center gap-4 mt-2 text-sm text-white/50">
                                    <button
                                        ...
                                        className={`flex items-center gap-1 hover:text-[#7C8FFF] ${parentComment.isLiked ? 'text-red-400' : ''}`}
                                    >
                ...
                <div className="p-4 border-t border-white/10 flex gap-3">
                    <input
                        ...
                        className="flex-1 bg-white/5 border border-white/10 rounded-full px-4 py-2 text-white placeholder:text-white/40 focus:outline-none focus:border-[#7C8FFF]/50"
                        onKeyDown={(e) => e.key === 'Enter' && handleSubmitReply()}
                    />
                    <button
                        onClick={handleSubmitReply}
                        disabled={!replyContent.trim()}
                        className="px-4 py-2 rounded-full bg-[#7C8FFF] text-white font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
                    >
                        Reply
                    </button>
                </div>

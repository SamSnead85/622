                ...
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    {step === 'landing' && (
                        <button
                            ...
                            className="px-5 py-2 rounded-xl bg-[#00D4FF] text-sm font-medium text-white hover:bg-[#00D4FF]/90 transition-all"
                        >
                            Apply Now
                        </button>
                    )}
            ...
            <AnimatePresence mode="wait">
                {step === 'landing' && !result ? (
                    <motion.div key="landing" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                        ...
                        <section className="relative overflow-hidden">
                            <div className="absolute inset-0">
                                <div className="absolute top-20 left-1/4 w-[500px] h-[300px] rounded-full blur-[150px] opacity-8 bg-[#00D4FF]" />
                                <div className="absolute bottom-10 right-1/4 w-[400px] h-[250px] rounded-full blur-[120px] opacity-6 bg-[#8B5CF6]" />
                            </div>
                            <div className="relative max-w-4xl mx-auto px-4 pt-16 sm:pt-24 pb-16 text-center">
                                ...
                                >
                                    <span className="text-xs text-[#00D4FF] font-medium">Creator Program</span>
                                ...
                                >
                                    <button
                                        onClick={() => setStep('apply')}
                                        className="px-8 py-3.5 rounded-xl bg-gradient-to-r from-[#00D4FF] to-[#00D4FF]/80 text-sm font-semibold text-white hover:opacity-90 transition-opacity"
                                    >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <motion.div
                                            ...
                                            className="p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06]"
                                        >
                                            <div className="w-10 h-10 rounded-xl bg-[#00D4FF]/10 border border-[#00D4FF]/20 flex items-center justify-center text-[#00D4FF] mb-4">
                                                {item.icon}
                                            </div>
                                    ...
                                    {TIERS.map((tier, i) => (
                                        <motion.div
                                            ...
                                            className={`p-6 rounded-2xl border ${tier.featured
                                                ? 'bg-[#00D4FF]/[0.04] border-[#00D4FF]/20'
                                                : 'bg-white/[0.02] border-white/[0.06]'
                                                }`}
                                        >
                                            {tier.featured && (
                                                <span className="inline-block px-2.5 py-0.5 rounded-full bg-[#00D4FF]/15 text-[10px] font-semibold text-[#00D4FF] uppercase tracking-wider mb-3">
                                                    Most Popular
                                                </span>
                                            )}
                                            ...
                                            <div className="space-y-2.5">
                                                {tier.perks.map((perk, j) => (
                                                    <div key={j} className="flex items-start gap-2">
                                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#00D4FF" strokeWidth="2" className="mt-0.5 shrink-0"><polyline points="20 6 9 17 4 12" /></svg>
                        ...
                        <section className="py-16 border-t border-white/[0.04]">
                            <div className="max-w-3xl mx-auto px-4 text-center">
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            <div key={i} className="flex items-center gap-4 text-left">
                                                <span className="text-xs font-mono text-[#00D4FF] w-20 shrink-0">{item.time}</span>
                                ...
                                <button
                                    onClick={() => setStep('apply')}
                                    className="mt-8 px-8 py-3.5 rounded-xl bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-sm font-semibold text-white hover:opacity-90 transition-opacity"
                                >
                    ...
                    >
                        ...
                        <Link href="/" className="text-sm text-[#00D4FF] hover:underline">Back to ZeroG</Link>
                    </motion.div>
                ) : (
                    <motion.div
                        key="apply"
                    ...
                    >
                        ...
                        <form onSubmit={handleApply} className="space-y-6">
                            ...
                            <button
                                ...
                                className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#00D4FF] to-[#00D4FF]/80 text-sm font-semibold text-white hover:opacity-90 transition-all disabled:opacity-40"
                            >

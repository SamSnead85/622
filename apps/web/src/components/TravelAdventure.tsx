                        ...
                        >
                            ...
                            <div className="mb-6">
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:border-[#00D4FF] focus:outline-none resize-none"
                                    rows={3}
                                />
                            </div>
            ...
            >
                                ...
                                {formData.destination === 'custom' && (
                                    ...
                                    >
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:border-[#00D4FF] focus:outline-none"
                                        />
                                    </motion.div>
                                )}
                            </motion.div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:border-[#00D4FF] focus:outline-none"
                                        />
                                    </div>
                                    <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                placeholder="Min"
                                                className="w-full pl-8 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:border-[#00D4FF] focus:outline-none"
                                            />
                                        </div>
                                        <div className="relative">
                                            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40">$</span>
                            ...
                            >
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:border-[#00D4FF] focus:outline-none"
                                    />
                                    <button
                                        onClick={addActivity}
                                        className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-white font-medium"
                                    >
                                        Add
                                    </button>
                                </div>
                                ...
                                {/* Preview */}
                                <div className="mt-8 p-4 bg-gradient-to-br from-[#00D4FF]/10 to-[#8B5CF6]/10 rounded-2xl border border-white/10">
                ...
                <div className="p-6 border-t border-white/5 flex justify-between">
                    ...
                    <button
                        ...
                        className="px-8 py-3 rounded-xl bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-white font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                    >
    ...
    if (adventures.length === 0) {
        return (
            <div className="text-center py-16">
                <div className="w-24 h-24 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-[#00D4FF]/20 to-[#8B5CF6]/20 flex items-center justify-center">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={onCreateNew}
                    className="px-8 py-4 rounded-2xl bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-white font-bold text-lg shadow-lg shadow-[#00D4FF]/20"
                >
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={onCreateNew}
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-white font-medium"
                >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">

        ...
        <>
            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        className="hidden md:flex fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] shadow-lg shadow-purple-500/25 items-center justify-center hover:scale-105 transition-transform"
                    >
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-gradient-to-r from-[#7C8FFF]/10 to-[#6070EE]/10">
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] flex items-center justify-center">
                                ...
                                <div className="p-3 border-t border-white/10">
                                    <div className="flex items-center gap-2 bg-white/5 rounded-xl px-3 py-2">
                                        ...
                                        <button
                                            ...
                                            className="p-2 rounded-lg bg-gradient-to-r from-[#7C8FFF] to-[#6070EE] text-white disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 transition-opacity"
                                        >
                                            <SendIcon size={16} />
                                        </button>
                                    </div>

        ...
        >
            ...
            >
                ...
                <div className="p-8 flex items-center justify-center">
                    <div className="p-4 bg-white rounded-2xl">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <div className="w-10 h-10 rounded-xl bg-[#7C8FFF] flex items-center justify-center text-white font-bold text-lg">
                                0G
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-6 pt-0 space-y-3">
                    <button
                        onClick={handleShare}
                        className="w-full py-3 rounded-xl bg-gradient-to-r from-[#7C8FFF] to-[#6070EE] text-white font-semibold hover:opacity-90 transition-opacity"
                    >
                        Share Profile
                    </button>
                    <button
                ...
                <div className="p-6 space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            min={minDate}
                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#7C8FFF]/50"
                        />
                    </div>
                    <div>

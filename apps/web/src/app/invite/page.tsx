...
const TIERS = [
    ...
    { name: 'Torchbearer', minJoined: 15, icon: '🏆', color: 'text-[#7C8FFF]', bg: 'from-[#7C8FFF]/10 to-[#6070EE]/5', border: 'border-[#7C8FFF]/30' },
    ...
    if (!mounted) {
        return (
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="w-16 h-16 rounded-full border-4 border-[#7C8FFF]/20 border-t-[#7C8FFF] animate-spin" />
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <main className="relative z-10 max-w-2xl mx-auto px-4 py-8 pb-24">
                ...
                >
                    <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] flex items-center justify-center shadow-[0_0_30px_rgba(0,212,255,0.2)]">
                ...
                >
                    ...
                    {nextTier && (
                        <div className="w-full h-2 bg-black/30 rounded-full overflow-hidden">
                            <motion.div
                                className="h-full rounded-full bg-gradient-to-r from-[#7C8FFF] to-[#6070EE]"
                                initial={{ width: 0 }}
                ...
                >
                    <div className="bg-white/5 rounded-2xl p-4 text-center border border-white/5">
                        <p className="text-2xl font-bold text-[#7C8FFF]">{inviteStats.sent}</p>
                ...
                {/* Your Invite Link */}
                <motion.div
                    className="bg-gradient-to-br from-[#7C8FFF]/10 to-[#6070EE]/10 rounded-2xl p-6 border border-[#7C8FFF]/20 mb-8"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    <div className="relative h-28 bg-gradient-to-br from-violet-900/50 to-[#7C8FFF]/20 overflow-hidden">
                        {user?.coverUrl && (
                        ...
                        <div className="absolute top-2.5 right-2.5">
                            <div className="w-6 h-6 rounded-md bg-black/40 backdrop-blur-sm flex items-center justify-center">
                                <span className="text-[7px] font-bold text-[#7C8FFF]">0G</span>
                            </div>
                        </div>
                    </div>
                ...
                {typeof navigator !== 'undefined' && 'share' in navigator && (
                    <motion.button
                        ...
                        className="w-full mb-6 py-4 rounded-2xl bg-gradient-to-r from-[#7C8FFF] to-[#6070EE] text-white font-bold text-lg flex items-center justify-center gap-3 hover:opacity-90 transition-opacity active:scale-[0.98]"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                >
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                            ...
                            className="text-xs text-[#7C8FFF] hover:text-[#7C8FFF]/80 transition-colors"
                        >
                    ...
                    {isEditingMessage ? (
                        <textarea
                            ...
                            maxLength={280}
                            rows={3}
                            className="w-full bg-black/50 rounded-xl px-4 py-3 text-white text-sm border border-white/10 focus:outline-none focus:border-[#7C8FFF]/30 resize-none transition-colors"
                ...
                {(user?.isGrowthPartner || user?.role === 'ADMIN' || user?.role === 'SUPERADMIN') && (
                    ...
                    >
                        <Link
                            ...
                            className="block w-full p-5 rounded-2xl bg-gradient-to-r from-emerald-500/10 to-[#7C8FFF]/10 border border-emerald-500/20 hover:border-emerald-500/40 active:scale-[0.98] transition-all"
                        >
            ...
            <nav className="fixed bottom-0 left-0 right-0 bg-black/90 backdrop-blur-xl border-t border-white/10 z-50 safe-area-pb">
                <div className="flex items-center justify-around py-3">
                    ...
                    <Link href="/invite" className="flex flex-col items-center gap-1 p-2 text-[#7C8FFF]">
                        <SendIcon size={22} />

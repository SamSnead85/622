        ...
        <div className="min-h-screen bg-black text-white p-4 sm:p-8 max-w-2xl mx-auto">
            ...
            {!exportComplete ? (
                <button
                    ...
                    className="w-full py-4 rounded-2xl bg-[#7C8FFF] text-white font-bold text-lg hover:opacity-90 disabled:opacity-50 transition-opacity"
                >
                    {isExporting ? (
                ...
                >
                    ...
                    <button
                        ...
                        className="mt-4 text-[#7C8FFF] text-sm hover:underline"
                    >
                        Export Again
                    </button>
                </motion.div>

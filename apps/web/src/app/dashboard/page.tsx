    ...
    return (
        <main className="min-h-screen bg-black text-white">
            ...
            <div className="fixed inset-0 pointer-events-none z-[-1]">
                ...
                <div className="absolute top-0 left-1/4 w-[600px] h-[600px] rounded-full bg-[#7C8FFF]/5 blur-[120px]" />
                <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-[#6070EE]/5 blur-[100px]" />
            </div>
                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-8 pb-24 lg:pb-8">
                                ...
                                <Link href="/profile">
                                    {user.avatarUrl ? (
                                        <img
                                            ...
                                            className="w-10 h-10 rounded-full object-cover ring-2 ring-[#7C8FFF]/30"
                                        />
                                    ) : (
                                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] flex items-center justify-center text-white font-bold">
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-white/[0.06] mb-2">
                        <div className="flex items-center bg-white/[0.04] rounded-full p-0.5">
                            ...
                            >
                                {feedView === 'community' && (
                                    <motion.div
                                        layoutId="feedViewToggle"
                                        className="absolute inset-0 bg-gradient-to-r from-[#7C8FFF]/20 to-[#6070EE]/20 border border-[#7C8FFF]/30 rounded-full"
                                        transition={{ type: 'spring', stiffness: 400, damping: 30 }}
                                    />
                                )}
                                <span className="relative z-10 flex items-center gap-1.5">
                                    ...
                                    Community
                                    {!communityOptIn && (
                                        <span className="text-[10px] bg-[#7C8FFF]/20 text-[#7C8FFF] px-1.5 py-0.5 rounded-full ml-1">Join</span>
                                    )}
                                </span>
                            </button>
                        </div>
                        ...
                        <div className={`flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full ${
                            feedView === 'private'
                                ...
                                : 'bg-[#7C8FFF]/10 text-[#7C8FFF] border border-[#7C8FFF]/20'
                        }`}>
                            {feedView === 'private' ? (
                                <>
                    ...
                    {posts.length === 0 && !postsLoading && (
                        <div className="space-y-4 py-4">
                            {/* Welcome card */}
                            <div className="bg-gradient-to-br from-[#7C8FFF]/10 via-[#6070EE]/5 to-transparent rounded-2xl border border-[#7C8FFF]/20 p-6 text-center">
                                ...
                                <div className="flex flex-wrap justify-center gap-3">
                                    <Link
                                        href="/create"
                                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#7C8FFF] to-[#6070EE] text-white font-semibold text-sm hover:opacity-90 transition-opacity"
                                    >
                                        <PlusIcon size={16} />
                                        Create Post
                                    </Link>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <Link href="/search" className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-4 hover:bg-white/[0.06] transition-colors group">
                                    ...
                                    <h4 className="text-sm font-semibold text-white group-hover:text-[#7C8FFF] transition-colors">Explore</h4>
                                ...
                                <Link href="/bulletin" className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-4 hover:bg-white/[0.06] transition-colors group">
                                    ...
                                    <h4 className="text-sm font-semibold text-white group-hover:text-[#7C8FFF] transition-colors">Bulletin Board</h4>
                                ...
                                <Link href="/communities/create" className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-4 hover:bg-white/[0.06] transition-colors group">
                                    ...
                                    <h4 className="text-sm font-semibold text-white group-hover:text-[#7C8FFF] transition-colors">Create a Group</h4>
                                ...
                                <Link href="/invite" className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-4 hover:bg-white/[0.06] transition-colors group">
                                    ...
                                    <h4 className="text-sm font-semibold text-white group-hover:text-[#7C8FFF] transition-colors">Invite Friends</h4>
                                ...
                                {!postsLoading && posts.length === 0 && (
                                    <div className="text-center py-12 bg-white/[0.02] rounded-2xl border border-white/5">
                                        ...
                                        <button
                                            ...
                                            className="px-6 py-2.5 rounded-xl bg-[#7C8FFF] text-white font-semibold text-sm hover:opacity-90 transition-opacity"
                                        >
                                            Create Post
                                        </button>
                                    </div>
                                ...
                                {hasMore && (
                                    <div ref={loadMoreRef} className="py-8 flex justify-center">
                                        <div onClick={loadMore} className="flex flex-col items-center gap-2 cursor-pointer group">
                                            ...
                                            <span className="text-xs text-white/40 group-hover:text-[#7C8FFF] transition-colors">Loading more...</span>
                                        </div>
                                    </div>
                                )}
                        ...
                        <div className="hidden lg:block space-y-4">
                            ...
                            <div className="bg-white/[0.03] rounded-2xl border border-white/[0.06] p-4">
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <Link href="/search" className="text-xs text-[#7C8FFF] hover:underline">See All</Link>
                                </div>
                            ...
                            {/* Invite Card */}
                            <div className="bg-gradient-to-br from-[#7C8FFF]/10 to-[#6070EE]/10 rounded-2xl border border-[#7C8FFF]/20 p-4">
                                ...
                                <Link
                                    href="/invite"
                                    className="block w-full py-2 rounded-xl bg-[#7C8FFF] text-white text-center font-semibold text-sm hover:opacity-90 transition-opacity"
                                >
                                    Send Invites
                                </Link>
                            </div>

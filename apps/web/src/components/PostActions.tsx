    ...
    return (
        <>
            ...
            <button
                ...
                className="p-2 rounded-full hover:bg-[#7C8FFF]/10 transition-all duration-200 hover:scale-110 group-hover:bg-white/5"
                        ...
                        >
                            ...
                            {isOwner && onPin && (
                                <button
                                    ...
                                    className={`w-full px-4 py-3 text-left transition-colors flex items-center gap-3 border-t border-white/10 ${isPinned ? 'text-[#7C8FFF]' : 'text-white hover:bg-white/5'}`}
                                >
                                    <MapPinIcon size={18} />
                                ...
                                <div className="rounded-xl overflow-hidden border border-white/10 bg-black/40">
                                    ...
                                    {postType === 'TEXT' && !mediaUrl && (
                                        <div className="p-6 text-center">
                                            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#7C8FFF]/20 to-[#6070EE]/20 flex items-center justify-center mx-auto mb-3">
                ...
                <input
                    ...
                    className={`w-full bg-white/5 border rounded-xl px-4 py-3 text-white placeholder:text-white/40 focus:outline-none transition-colors ${isValid === true
                        ...
                        : isValid === false
                            ...
                            : 'border-white/10 focus:border-[#7C8FFF]/50'
                        }`}
                />
                {isValid !== null && (

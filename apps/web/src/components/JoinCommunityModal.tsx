                    ...
                    {step === 'intro' && (
                        <div className="p-6 space-y-5">
                            <div className="text-center">
                                <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[#7C8FFF]/20 to-[#6070EE]/20 border border-[#7C8FFF]/20 flex items-center justify-center">
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#7C8FFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-3 rounded-xl bg-gradient-to-r from-[#7C8FFF] to-[#6070EE] text-white font-semibold text-sm hover:opacity-90 transition-opacity"
                                >
                                    Continue
                                </button>
                            </div>
                        ...
                        <div className="p-6 space-y-5">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="w-12 h-12 rounded-full overflow-hidden flex-shrink-0">
                                            {user?.avatarUrl ? (
                                                ...
                                                <div className="w-full h-full bg-gradient-to-br from-[#7C8FFF] to-[#6070EE] flex items-center justify-center text-white font-bold">
                                        ...
                                        <div className="ml-auto">
                                            <div className={`w-5 h-5 rounded-full border-2 ${
                                                identityChoice === 'same' ? 'border-[#7C8FFF] bg-[#7C8FFF]' : 'border-white/30'
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-violet-500/30 to-purple-500/30 border border-violet-500/30 flex items-center justify-center flex-shrink-0">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#99AAFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                        ...
                                        <div className="ml-auto">
                                            <div className={`w-5 h-5 rounded-full border-2 ${
                                                identityChoice === 'separate' ? 'border-[#6070EE] bg-[#6070EE]' : 'border-white/30'
                                            } flex items-center justify-center`}>
                                                {identityChoice === 'separate' && (
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-3 rounded-xl bg-gradient-to-r from-[#7C8FFF] to-[#6070EE] text-white font-semibold text-sm hover:opacity-90 transition-opacity disabled:opacity-40"
                                >
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 rounded-xl bg-white/[0.06] border border-white/[0.1] text-white placeholder-white/30 focus:border-[#7C8FFF]/50 focus:outline-none transition-colors"
                                        maxLength={50}
                                    />
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-9 pr-4 py-3 rounded-xl bg-white/[0.06] border border-white/[0.1] text-white placeholder-white/30 focus:border-[#7C8FFF]/50 focus:outline-none transition-colors"
                                            maxLength={30}
                                        />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={2}
                                        className="w-full px-4 py-3 rounded-xl bg-white/[0.06] border border-white/[0.1] text-white placeholder-white/30 focus:border-[#7C8FFF]/50 focus:outline-none transition-colors resize-none"
                                        maxLength={300}
                                    />
                                </div>
                            </div>
